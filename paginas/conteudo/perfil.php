              ...
              <?php
                ...
                if (isset($_POST['upPerfil'])) {
                    ...
                    if (!empty($_FILES['foto']['name'])) {
                        ...
                        $novoNome = $foto_user; // Mantém a foto antiga se não houver upload de nova foto
                    }
                    ...
                    try {
                        ...
                        if ($contar > 0) { // Verifica se alguma linha foi afetada
            ...
            <div class="card">
              ...
              <?php
                    ...
                    if ($show->foto_user == 'avatar-padrao.png') {
                        ...
                        echo '<img src="../img/avatar_p/' . $show->foto_user . '" alt="' . $show->foto_user . '" title="' . $show->foto_user . '" style="width: 250px; border-radius: 100%;">';
                    } else {
                        // Exibe a imagem do usuário
                        echo '<img src="../img/user/' . $show->foto_user . '" alt="' . $show->foto_user . '" title="' . $show->foto_user . '" style="width: 250px; border-radius: 100%;">';
                    }
              ?>
