            ...
            <div class="card">
              ...
              <?php
                    ...
                    if ($show->foto_contatos == 'avatar-padrao.png') {
                        ...
                        echo '<img src="../img/avatar_p/' . $show->foto_contatos . '" alt="' . $show->foto_contatos . '" title="' . $show->foto_contatos . '" style="width: 250px; border-radius: 100%;">';
                    } else {
                        // Exibe a imagem do usuário
                        echo '<img src="../img/cont/' . $show->foto_contatos . '" alt="' . $show->foto_contatos . '" title="' . $show->foto_contatos . '" style="width: 250px; border-radius: 100%;">';
                    }
                    ?>
                <h1><?php echo $nome; ?></h1>
